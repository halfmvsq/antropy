...
public:
    ...
    std::optional<Polygon::PointType> getBoundaryVertex( size_t boundary, size_t i ) const;
    ...
    std::optional< std::tuple< IndexType, IndexType, IndexType > > getTriangle( size_t i ) const;
