...
public:
    virtualGizmoBaseClass() : pos(0), delta(0),
                           tbControlButton(evLeftButton), tbRotationButton(evRightButton),
                           tbControlModifiers(evNoModifier),
    ...
    void updateGizmo() 
    {
        ...
        //if(!delta.x && !delta.y) {
        if ( glm::all( glm::epsilonEqual( delta, glm::vec2{0.0f}, glm::epsilon<float>() ))) {
...
public:
    //////////////////////////////////////////////////////////////////
    virtualGizmo3DClass() : dollyControlButton(evRightButton),   panControlButton(evMiddleButton),
                         dollyControlModifiers(evNoModifier), panControlModifiers(evNoModifier),
                         dollyActive(false), panActive(false) { }
